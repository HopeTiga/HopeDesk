...
namespace hope {
	...
	namespace rpc {
		...
		void CoroRpcHandlerImpl::registerRpcHandler() {
			...
			coroRpc->registerHandler<&CoroRpcHandlerImpl::requestForward>(this);
			
		}

		async_simple::coro::Lazy<RpcForwardResponse> CoroRpcHandlerImpl::requestForward(RpcForward rpcforward) {
